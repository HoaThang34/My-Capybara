document.addEventListener('DOMContentLoaded', () => {
    const themes = [
        ...
        { id: 'fox', level: 9, name: "Tay Đua Cáo Con", playerIcon: '🏁', character: '🦊', winTitle: "VỀ ĐÍCH!", winSubtitle: "Một tay đua cừ khôi!", gameMode: 'timed', timePerQuestion: 600, colors: { '--bg-color': '#fbe9e7', '--primary-color': '#ff5722', '--secondary-color': '#ff8a65', '--text-color': '#bf360c', '--secondary-color-translucent': 'rgba(255, 138, 101, 0.85)', '--primary-color-dark': '#e64a19' } },
        ...
        { id: 'dolphin', level: 13, name: "Cá Heo Tìm Ngọc Trai", playerIcon: '🫧', character: '🐬', winTitle: "TÌM THẤY KHO BÁU!", winSubtitle: "Nhanh như một chú cá heo!", gameMode: 'timed', timePerQuestion: 600, colors: { '--bg-color': '#e1f5fe', '--primary-color': '#039be5', '--secondary-color': '#4fc3f7', '--text-color': '#01579b', '--secondary-color-translucent': 'rgba(79, 195, 247, 0.85)', '--primary-color-dark': '#0277bd' } },
        ...
        { id: 'phoenix', level: 15, name: "Đối mặt Phượng Hoàng", playerIcon: '🔥', character: '🐦', winCharacter: '🔥', winTitle: "THỬ THÁCH CUỐI CÙNG!", winSubtitle: "Bé đã chinh phục Thế Giới Diệu Kỳ!", gameMode: 'hardcore', timePerQuestion: 600, colors: { '--bg-color': '#ffccbc', '--primary-color': '#d84315', '--secondary-color': '#ff7043', '--text-color': '#bf360c', '--secondary-color-translucent': 'rgba(255, 112, 67, 0.85)', '--primary-color-dark': '#bf360c' } },
...
{ id: 'gorilla', level: 59, name: "Vương Quốc Gorilla", playerIcon: '🍌', character: '🦍', winTitle: "VỊ VUA CỦA RỪNG RẬM!", winSubtitle: "Bé đã chứng tỏ được sức mạnh và trí tuệ!", gameMode: 'timed', timePerQuestion: 600, colors: { '--bg-color': '#3e2723', '--primary-color': '#a1887f', '--secondary-color': '#d7ccc8', '--text-color': '#efebe9', '--secondary-color-translucent': 'rgba(215, 204, 200, 0.85)', '--primary-color-dark': '#6d4c41' } },
{ id: 'godzilla', level: 60, name: "Thành Phố Trỗi Dậy", playerIcon: '🏙️', character: '🦎', winCharacter: '🦖', winTitle: "SIÊU THỬ THÁCH!", winSubtitle: "Bé đã chinh phục được thử thách khó nhất!", gameMode: 'hardcore', timePerQuestion: 600, colors: { '--bg-color': '#212121', '--primary-color': '#4caf50', '--secondary-color': '#a5d6a7', '--text-color': '#c8e6c9', '--secondary-color-translucent': 'rgba(165, 214, 167, 0.85)', '--primary-color-dark': '#2e7d32' } },
...
{ id: 'mosquito', level: 85, name: "Đội quân Muỗi", playerIcon: '🦟', character: '🦟', winTitle: "MỘT ĐÊM YÊN GIẤC!", winSubtitle: "Bé đã đuổi hết những con muỗi vo ve!", gameMode: 'timed', timePerQuestion: 600, colors: { '--bg-color': '#f5f5f5', '--primary-color': '#757575', '--secondary-color': '#bdbdbd', '--text-color': '#212121', '--secondary-color-translucent': 'rgba(189, 189, 189, 0.85)', '--primary-color-dark': '#424242' } },
{ id: 'cockroach', level: 86, name: "Gián Tinh Ranh", playerIcon: '🪳', character: '🪳', winTitle: "DỌN SẠCH BẾP!", winSubtitle: "Không còn con gián nào nữa!", gameMode: 'hardcore', timePerQuestion: 600, colors: { '--bg-color': '#efebe9', '--primary-color': '#6d4c41', '--secondary-color': '#a1887f', '--text-color': '#3e2723', '--secondary-color-translucent': 'rgba(161, 136, 127, 0.85)', '--primary-color-dark': '#4e342e' } },
...
{ id: 'abyss', level: 90, name: "Vực Thẳm Vô Tận", playerIcon: '🌀', character: '🌌', winTitle: "BÍ ẨN CỦA VŨ TRỤ!", winSubtitle: "Hành trình của bé chỉ mới bắt đầu...", gameMode: 'hardcore', colors: { '--bg-color': '#000000', '--primary-color': '#ffffff', '--secondary-color': '#9e9e9e', '--text-color': '#ffffff', '--secondary-color-translucent': 'rgba(158, 158, 158, 0.85)', '--primary-color-dark': '#e0e0e0' } }
    ...
    function startTimer() {
        ...
        const timePerQuestionMs = (currentTheme.timePerQuestion || 600) * 100;
